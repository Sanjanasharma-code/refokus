...
const Stripes = () => {
    ...
    const data = [
        { URL:"https://assets-global.website-files.com/6334198f239547d0f9cd84b3/63c9ce90a51cd7cf6b3689fb_css-design-awards-logos-id1L9L8Yvp%201.svg", number:"58"},
  ...
  return (
    <div className='flex items-center justify-between mt-20 bg-zinc-800'>
       {data.map((elem,index) => (
        <Stripe val={elem}/>
       ))}
    </div>

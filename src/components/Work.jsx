    ...
    return (
        <div className='w-full realtive'>
            <div className='max-w-screen-xl mx-auto  text-center relative'>
                <h1 className='text-[30vw] leading-none text-white font-semibold mt-20'>Work</h1>
                <div className='w-full h-full  absolute top-0'>
                    {images.map((elem, inedx) => (elem.isActive && (<img className='w-60 absolute rounded-md -translate-x-[50%] -translate-y-[50%] ' src={elem.URL} style={{ top: elem.top, left: elem.left }} alt="" srcset="" />)))}
                </div>
            </div>
        </div>
    )
